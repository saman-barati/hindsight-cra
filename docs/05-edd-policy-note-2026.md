...
|---|---|---|
| Touching a FATF increased-monitoring jurisdiction | 11 | 2.8% |
| Touching a FATF call-for-action jurisdiction | 5 | 1.2% |
| Mandatory jurisdiction-based EDD before 2026 | 16 | 4.0% |
| Mandatory jurisdiction-based EDD under the 2026 rule | 5 | 1.2% |
| Customers losing automatic EDD | 11 | 2.8% |
| Of those, escalated for some other reason | 0 | 0.0% |
| Of those, rated Low once EDD is no longer automatic | 9 | 2.2% |

## 3. The gap

3.1 **11 customers — 69% of everyone who had jurisdiction-based enhanced due diligence — lose it.**
