...
5.2 There are two reasons. The first is legal. Nationality is not itself one of the protected characteristics listed at section 4 of the Equality Act 2010; it is protected as an aspect of **race**, which section 9(1)(b) defines as including colour, nationality and ethnic or national origins. Scoring nationality is therefore scoring a protected characteristic, and the earlier wording of this paragraph, which called nationality a protected characteristic in its own right, was corrected after an external review pointed it out. The conclusion is unchanged; the route to it was wrong, and in a document whose whole argument is that citations should be checkable, that mattered.
...
- FCA Final Notice, Monzo Bank Ltd, 8 July 2025 — https://www.fca.org.uk/publication/final-notices/monzo-bank-limited.pdf
